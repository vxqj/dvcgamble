...
// record ({ id, username, is_admin }) straight from Postgres. Every API
// route that needs to know "who is this" — including every admin route —
// must go through this. Never trust a username or an admin flag sent in a
// request body; the server always looks both up itself from the token.
//
...
// session — or a just-flipped is_admin flag — is never trusted for long.

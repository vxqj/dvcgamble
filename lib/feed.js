...
export function broadcastPull({ rarityKey, rarityLabel, color, name, packLabel }) {
  queue.push({ rarityKey, rarityLabel, color, name, packLabel, _idx: rarityIndex(rarityKey) });
  pump();
}

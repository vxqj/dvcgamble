  ...
  sections: [
    {
      heading: "Fixes",
      items: [
        "Fixed pack opening sometimes failing to record card pulls.",
        "Improved save reliability so progress persists more consistently.",
      ],
    },
    {
      heading: "Known Issues",
      items: [
        "The site may be slower than usual while we work through some backend issues thanks for your patience.",
      ],
    },
    {

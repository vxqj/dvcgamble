...
export const RARITIES = [
  ...
  prismatic: true, fx: 4, sellValue: 500000,
  ...
  prismatic: true, fx: 4, sellValue: 180000,
  ...
  sections: [
    {
      heading: "1/08/2026",
      items: [
        "New Auction system where you can auction cards, and players can bid on them.",
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        "The site got slow because an old, unrelated project was still connected to the same database in the background.",
      ],
    },
  ],
};
...
export const RARITIES = [
  {
  key: "Eternal", label: "Eternal", weight: 0.001,
  color: "#f5f5ff",
...
export const PACKS = [
  ...
  },
  {
    ...
    cost: 5000,
    cardsPerPack: 4,
    rarityMultipliers: { common: 0.2, rare: 0.6, epic: 2, legendary: 5, mythical: 7, secret: 10, Universal: 7, VM: 12, Ascended: 15, Sovereign: 17, Bloodline: 19, Apex: 21, Sacred: 23, Transcendent: 25, Singularity: 27, Digital: 30, Chaos: 33, Revenant: 36 },
    guaranteeRarity: "legendary",
    icon: "vault",
    accent: "#ff9d1f",
...
{
  key: "✡",
  allowedUsernames: ["NeonTitan2923"],
  label: "✡",
  description: "-",
  color: "#005EB8",

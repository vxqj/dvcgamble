...
/* --------------------------------------------------------------------------
   ...
   - prismatic: optional — if true, this rarity gets the full shimmering
     ...
     very top tier(s) — currently VM and Universal. (Also gated by the
     ENABLE_PRISMATIC_ANIMATION switch above — set that to false to turn
     the effect off everywhere without touching these flags.)
...
export const CARDS = {
  ...
  VM: ["T Landy", "O Williams", "S Rith"],
  Universal: ["JVS", "Jai W", "Cannon", "Prime Year 7 Eden Harris"],
  secret: ["Nathan F", "Izaac F", "Big C", "Efan Bee"],
  mythical: [
    "Sam March", "Archie Doyl", "Mav Danahay", "Big Baaaaaaaaaaaz", "Levin",
    "Punett", "Seven", "Dane / Callie", "Mini Keff", "Bezina", "Scott Burn",
  ],
  legendary: [
...
export const PACKS = [
  ...
  },
  {
    ...
    rarityMultipliers: { common: 15, Universal: 5 },
    guaranteeRarity: null,
    icon: "dice",
    accent: "#ff2ec4",
  },
...
export const UPGRADES = {
  multiOpen: {
    ...
    baseCost: 300,
    costGrowth: 2.2,
    maxLevel: 8, // level 0 = 1 pack at once, level 8 = 9 packs at once
  },
  coinBoost: {
    key: "coinBoost",
    label: "Coin Boost",

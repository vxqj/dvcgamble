...
export const RARITIES = [
  {
  key: "Relic", label: "Relic", weight: 0.5,
  color: "#7dff8a",
  gradient: "linear-gradient(120deg, #050505 0%, #12301a 20%, #7dff8a 50%, #c8b04a 80%, #000000 100%)",
  prismatic: true, fx: 5, sellValue: 1000000,
  pulseColors: ["#7dff8a", "#d8ffb0", "#c8b04a", "#000000"],
  serialsEnabled: true,
},
  {
  key: "Apex", label: "Apex", weight: 1.5, color: "#ffd700",
  gradient: "linear-gradient(120deg, #050505 0%, #3d2a00 20%, #ffd700 50%, #8f6a00 80%, #000000 100%)",
  prismatic: true, fx: 4, sellValue: 450000,
  pulseColors: ["#ffd700", "#fff4b0", "#c99a00", "#000000"],
  serialsEnabled: true,
},
  {
  key: "Bloodline", label: "Bloodline", weight: 2.5, color: "#d1001f",
...
/* --------------------------------------------------------------------------
   ...
   -------------------------------------------------------------------------- */
export const CARDS = {
  Relic: ["Brandon Kuriaku"],
  Apex: ["Harry Machin", "Noah Hosking"],
  Bloodline: ["Evil Willis", "Jewan"],

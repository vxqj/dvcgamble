...
export const PACKS = [
  ...
  },
  {
    ...
    cost: 15000000,
    cardsPerPack: 7,
    rarityMultipliers: { common: 0.2, rare: 0.6, epic: 2, legendary: 5, mythical: 7, secret: 10, Universal: 7, VM: 20, Ascended: 23, Sovereign: 26, Bloodline: 29, Apex: 31, Sacred: 34, Transcendent: 37, Singularity: 40, Digital: 50, Chaos: 80, Revenant: 90, Danabros: 100, Veteran: 125, BarkerFamily: 150, Prime: 200, Supreme: 250 },
    guaranteeRarity: "secret",
    icon: "dice",
    accent: "#ff1f1f",
  },

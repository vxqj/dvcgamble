...
export const RARITIES = [
  {
  key: "Apex", label: "Apex", weight: 0.01, color: "#ffd700",
...
export const PACKS = [
  ...
  },
  {
    ...
    cost: 350000,
    cardsPerPack: 5,
    rarityMultipliers: { common: 0.2, rare: 0.6, epic: 2, legendary: 5, mythical: 7, secret: 10, Universal: 7, VM: 20, Ascended: 8, Sovereign: 6, Bloodline: 4 },

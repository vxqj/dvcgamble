...
export const RARITIES = [
  ...
  prismatic: true, fx: 7, sellValue: 25000000,
...
},
  {
    ...
    prismatic: true, fx: 4, sellValue: 150000,
...
export const PACKS = [
  ...
  },
  {
    ...
    cost: 700,
    cardsPerPack: 4,
    rarityMultipliers: { common: 0.2, rare: 0.6, epic: 2, legendary: 5, mythical: 7, secret: 10, Universal: 7, VM: 10, Ascended: 12, Sovereign: 15, Bloodline: 17, Apex: 19, Sacred: 21, Transcendent: 23, Singularity: 25 },
  ...
  },
  {
    ...
    cost: 2500,
    cardsPerPack: 4,
    rarityMultipliers: { common: 0.2, rare: 0.6, epic: 2, legendary: 5, mythical: 7, secret: 10, Universal: 7, VM: 12, Ascended: 15, Sovereign: 17, Bloodline: 19, Apex: 21, Sacred: 23, Transcendent: 25, Singularity: 27 },
    guaranteeRarity: "legendary",
    icon: "vault",
    accent: "#ff9d1f",
  ...
  },
  {
    ...
    cost: 10000,
    cardsPerPack: 3,
    rarityMultipliers: { common: 0.2, rare: 0.6, epic: 2, legendary: 5, mythical: 7, secret: 10, Universal: 7, VM: 15, Ascended: 17, Sovereign: 19, Bloodline: 21, Apex: 23, Sacred: 25, Transcendent: 27, Singularity: 29 },
  ...
  },
  {
    ...
    cost: 350000,
    cardsPerPack: 5,
    rarityMultipliers: { common: 0.2, rare: 0.6, epic: 2, legendary: 5, mythical: 7, secret: 10, Universal: 7, VM: 20, Ascended: 23, Sovereign: 26, Bloodline: 29, Apex: 31, Sacred: 34, Transcendent: 37, Singularity: 40 },
...
export const EVENT_CONFIG = {
  enabled: true,
  endsAt: "2026-08-06T10:00:00+10:00",
};
...
/* --------------------------------------------------------------------------
   TITLES
   Cosmetic 3-letter tags a player earns by hatching a card of the linked
   rarity at least once (checked against `discoveredCards`, which already
   permanently records every rarity a player has ever pulled — see
   lib/engine.js's unlockedTitleKeys, no extra server-side tracking needed).
   Once unlocked, a title can be equipped (one at a time, see Titles tab)
   and then shows as [KEY] next to that player's name in the TopBar and the
   Global Feed.
   - key: the 3-letter tag shown once equipped, e.g. [APX]. Keep these
     unique and exactly 3 characters.
   - rarityKey: which RARITIES entry unlocks this title the first time a
     card of that rarity is hatched. Label/color/gradient are pulled
     straight from that rarity at render time (see lib/engine.js), so a
     title never drifts out of sync with its rarity's look.
   Add a new title for any rarity by adding one line here — nothing else
   needs to change.
   -------------------------------------------------------------------------- */
export const TITLES = [
  ...
  sections: [
    {
      heading: "1/08/2026",
      items: [
        "DVCGAMBLE is now fixed, vercel free trial ran out (you might have to log back into your account).",
      ],
    },
    {
      heading: "Known Issues",
      items: [
        "Card sizes arent the same.",
        "Packs sometimes disappear."
      ],
    },
  ],
};
...
export const RARITIES = [
  ...
  prismatic: true, fx: 9, sellValue: 55000000000,
...
export const PACKS = [
  ...
  },
  {
    key: "DVC Pack",
    label: "DVC Pack",
    description: "Mad Expensive. Great Outcome, Guaranteed Veteran + .",
    cost: 10000000000,
    cardsPerPack: 7,
    rarityMultipliers: { common: 0.2, rare: 0.6, epic: 2, legendary: 5, mythical: 7, secret: 10, Universal: 7, VM: 20, Ascended: 23, Sovereign: 26, Bloodline: 29, Apex: 31, Sacred: 34, Transcendent: 37, Singularity: 40, Digital: 5000, Chaos: 8000, Revenant: 15000, Danabros: 25000, Veteran: 50000, BarkerFamily: 75000, Prime: 100000, Supreme: 125000 },
    guaranteeRarity: "Veteran",
    icon: "dice",
    accent: "#1fceff",
  },
];

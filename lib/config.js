...
export const RARITIES = [
  {
  key: "Revenant", label: "Revenant", weight: 0.0005,
  color: "#72ff9d",
  gradient: "linear-gradient(120deg, #000000 0%, #062b18 20%, #72ff9d 45%, #00b86b 70%, #000000 100%)",
  prismatic: true, fx: 7, sellValue: 100000000,
  pulseColors: ["#72ff9d", "#c6ffd8", "#00b86b", "#000000"],
  serialsEnabled: true,
},
  {
  key: "Chaos", label: "Chaos", weight: 0.001,
  color: "#ff2a5c",
  ...
  {
  key: "Digital", label: "Digital", weight: 0.009,
  color: "#00ff95",
...
/* --------------------------------------------------------------------------
   ...
   -------------------------------------------------------------------------- */
export const CARDS = {
  Revenant: ["Sanara", "Grandma Giles"], 
  Chaos: ["Willis Art Incident", "Milan VS Christian T"],
